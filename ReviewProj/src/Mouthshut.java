...
public class Mouthshut {
 ...
 {   //span[@class="rName"]
	//div[@class="vew_opn"]
	 ...
	 PrintWriter writer = new PrintWriter("Snjb.txt", "UTF-8");
 ...
 writer.close();
  ...
  writer.close();
	...
	public static void main(String[] args) throws InterruptedException, FileNotFoundException, UnsupportedEncodingException {
		...
		String k= "https://www.justdial.com/Nashik/SNJB-s-Late-Sau-Kantabai-Bhavarlalji-Jain-College-Of-Engineering-Neminagar-Chandwad/0253PX253-X253-151019113056-B2P9_BZDET/reviews";
